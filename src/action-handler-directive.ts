...
// TODO You need to replace all instances of "action-handler-lg-washer-dryer-card" with "action-handler-<your card name>"
customElements.define('action-handler-lg-washer-dryer-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-lg-washer-dryer-card')) {
    return body.querySelector('action-handler-lg-washer-dryer-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-lg-washer-dryer-card');
